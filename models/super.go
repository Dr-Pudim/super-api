...
type Super struct {
	...
	PlaceOfBirth    nulls.String `json:"place_of_birth" db:"place_of_birth"`
	FirstAppearance nulls.String `json:"first_appearance" db:"first_appearance"`
	...
	Race            nulls.String `json:"race" db:"race"`
	...
	EyeColor        nulls.String `json:"eye_color" db:"eye_color"`
	HairColor       nulls.String `json:"hair_color" db:"hair_color"`
	Occupation      nulls.String `json:"occupation" db:"occupation"`
	Base            nulls.String `json:"base" db:"base"`
